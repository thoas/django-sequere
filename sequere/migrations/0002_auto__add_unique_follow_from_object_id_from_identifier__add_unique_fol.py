...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Follow', fields ['from_object_id', 'from_identifier', 'to_object_id', 'to_identifier']
        db.create_unique(u'sequere_follow', ['from_object_id', 'from_identifier', 'to_object_id', 'to_identifier'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Follow', fields ['from_object_id', 'from_identifier', 'to_object_id', 'to_identifier']
        db.delete_unique(u'sequere_follow', ['from_object_id', 'from_identifier', 'to_object_id', 'to_identifier'])
